              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 ...
                 <?php
                    ...
                    echo form_open_multipart('ropa/add',$formulario);
                  ?>

								<div class="form-group">
                      <label for="titulo_ropa">Titulo de la Prenda</label>
                      <input required type="text" class="form-control" id="titulo_ropa" placeholder="Titulo de la Prenda(Sera vista en grande y negrita)" name="titulo_ropa">
                      <?php
                ...
                <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="color_ropa" placeholder="Descripci&oacute;n del Color" name="color_ropa">
                        <?php
                ...
                <div class="form-group">
                        ...
                        <textarea required class="form-control" id="descripcion_ropa" placeholder="Descripci&oacute;n General" name="descripcion_ropa"> </textarea>
                        <?php
                         ...
                         ?>
								...
								<div class="form-group">
												...
												<input required type="text" class="form-control" id="cantidad_ropa" placeholder="Cantidad de Ropa en el stock" name="cantidad_ropa">
												<?php
                        ...
                        <input required class="form-control" id="precio_ropa" placeholder="Ingrese Precio Ej: 1250.00" name="precio_ropa">
                        <?php
                      ...
                      <label for="color_ropa">Menu de la Prenda</label>
                       <select required class="form-control" id="tipo_ropa" name="tipo_ropa">
                          ...
                          <?php foreach ($menus as $menu): ?>
                              <option value="<?php echo $menu->id_tipo_ropa ?>"><?php echo $menu->nombre_tipo_ropa ?></option>
                          <?php endforeach; ?>
                       </select>
                       <?php
              ...
              <div class="form-group">
                       ...
                       <select required class="form-control" id="sub_tipo_ropa" name="sub_tipo_ropa">
                          ...
                          <?php foreach ($submenus as $submenu): ?>
                              <option value="<?php echo $submenu->id_sub_tipo_ropa ?>"><?php echo $submenu->nombre_sub_tipo_ropa ?></option>
                          <?php endforeach; ?>
                       </select>
                       <?php
               ...
               <div class="form-group">
                       ...
                       <?php
                        ...
                        ?>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<center><button class="btn btn-primary" type="submit" id="button">Guarda la Nueva Prenda</button></center>
								</div>
