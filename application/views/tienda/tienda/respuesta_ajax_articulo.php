    ...
    <div class="carousel-item active">
        <img class="d-block" src="<?php echo base_url().'public/images_ropa/'.$articulos[0]->imagen_ropa?>" alt="No hay Imagen">
          <div class="carousel-caption">
              ...
              <p>
                    <a href="<?php echo base_url();?>tienda/carrito_agregar/<?php echo $articulos[0]->id_ropa_tienda ?>" data-toggle="tooltip" data-placement="bottom" title="Agregar al Carrito" style="font-size: 1.5em; color: white;" type="button" class="btn btn-info">
          ...
          <div class="carousel-item">
              <img class="d-block" src="<?php echo base_url().'public/images_ropa/'.$articulo->imagen_ropa?>" alt="No hay Imagen">
                <div class="carousel-caption">
                    ...
                    <p>
                          <a href="<?php echo base_url();?>tienda/carrito_agregar/<?php echo $articulo->id_ropa_tienda ?>" data-toggle="tooltip" data-placement="bottom" title="Agregar al Carrito" style="font-size: 1.5em; color: white;" type="button" class="btn btn-info">
                          <i class="fas fa-shopping-cart"></i>
                        </a>

                          <a href="<?php echo base_url();?>tienda/carrito_agregar/<?php echo $articulo->id_ropa_tienda ?>" data-toggle="tooltip" data-placement="bottom" title="Comprar" style="font-size: 1.5em; color: white;" type="button" class="btn btn-primary">
                            <i class="fas fa-money-bill-alt"></i>
                          </a>
